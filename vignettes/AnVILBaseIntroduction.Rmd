...
The following generics are defined in the `AnVILBase` package for data:

- `avdata`: Get "reference" and "other" data from a workspace
- `avdata_import`: Upload data to a workspace's attributes
